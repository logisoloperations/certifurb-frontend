...
const CategoryPage = () => {
  ...
  // Determine the category from URL
  useEffect(() => {
  ...
  // Reset all filters when component mounts or category changes
  useEffect(() => {
  ...
  const filteredProducts = products.filter(product => {
    ...
    // Category filtering (already done by API, but double-check)
    ...
    return isInPriceRange && matchesCategory &&
            ...
            <div className="flex items-center justify-center py-12">
              <div className="text-center">
                <p className="text-gray-600 mb-4">
                  No {getCategoryDisplayName().toLowerCase()} found
                </p>
                <Link
                  href="/category"
                  className="bg-green-500 text-white px-4 py-2 rounded-lg hover:bg-green-600 transition"
