    ...
    const checkLoginState = () => {
      ...
      if (userData) {
        try {
          ...
          if (
            parsedUser &&
            (parsedUser.userId || parsedUser.useremail || parsedUser.email)
          ) {
            setUser(parsedUser);
            setIsLoggedIn(true);
    ...
    <div className={`${font.className} relative`}>
      ...
      <div className="w-full flex text-white font-bold text-xs md:text-sm lg:text-md justify-center items-center p-2 md:p-1 custom-green-bg">
        <p className="text-center px-2">
          GET 100 PKR OFF YOUR FIRST ORDER- ENTER CODE NEW25 AT CHECKOUT
        </p>
      </div>
          ...
          <div className="relative country-dropdown">
            ...
            {isCountryDropdownOpen && (
              <div className="absolute top-full right-0 mt-1 w-16 bg-white rounded-lg shadow-lg border border-gray-200 z-50">
                <div className="py-1">
                  {["Pakistan", "United States", "United Arab Emirates"].map(
                    (country) => (
                      <button
                        key={country}
        ...
        <div className="flex lg:hidden items-center space-x-3 text-lg">
          ...
          {(selectedCountry === "United Arab Emirates" ||
            ...
            <div className="cursor-pointer">
              <a
                href="https://glonect.ae/home"
                target="_blank"
                rel="noopener noreferrer"
                className="px-2 py-1 rounded-full bg-green-500 text-white text-xs font-semibold hover:bg-gray-50"
              >
                Visit Glonect - UAE
              </a>
            </div>
      ...
      {(selectedCountry === "United Arab Emirates" ||
        selectedCountry === "UAE" ||
        selectedCountry === "AE") && (
        <div className="cursor-pointer flex justify-end pb-4 px-4">
          <a
            href="https://glonect.ae/home"
            target="_blank"
            rel="noopener noreferrer"
            className="px-3 py-1 bg-green-500 text-white rounded-full border border-gray-200 text-sm font-semibold"
          >
            Visit Glonect - UAE
          </a>
        </div>
      ...
      <div className="hidden lg:flex space-x-[33px] font-bold bg-white dark:text-black pt-3 pb-3 justify-center items-center">
        ...
        >
          ...
          {isLaptopDropdownOpen && (
            <div className='absolute top-full left-0 mt-1 w-40 bg-white rounded-lg shadow-lg border border-gray-200 z-50'>
              <div className='py-1'>
                <Link href="/laptops/lenovo">
                  <div className='px-4 py-2 hover:bg-gray-100 cursor-pointer text-sm font-medium'>
                    Lenovo
                  </div>
                </Link>
                <Link href="/laptops/microsoft">
                  <div className='px-4 py-2 hover:bg-gray-100 cursor-pointer text-sm font-medium'>
                    Microsoft
                  </div>
                </Link>
                <Link href="/laptops/hp">
                  <div className='px-4 py-2 hover:bg-gray-100 cursor-pointer text-sm font-medium'>
                    HP
                  </div>
                </Link>
                <Link href="/laptops/dell">
                  <div className='px-4 py-2 hover:bg-gray-100 cursor-pointer text-sm font-medium'>
                    Dell
                  </div>
                </Link>
        ...
        <Link href={"/desktops"}><p className='cursor-pointer hover:text-gray-600 transition-colors'>Desktop PC</p></Link>
        <Link href={"/printers"}><p className='cursor-pointer hover:text-gray-600 transition-colors'>Printer</p></Link>
        <Link href={"/monitors"}><p className='cursor-pointer hover:text-gray-600 transition-colors'>Monitors</p></Link>
        <Link href={"/mice"}><p className='cursor-pointer hover:text-gray-600 transition-colors'>Mouse</p></Link>
        <Link href={"/keyboards"}><p className='cursor-pointer hover:text-gray-600 transition-colors'>Keyboard</p></Link>
        <Link href={"/tablets"}><p className='cursor-pointer hover:text-gray-600 transition-colors'>Tablet</p></Link>
        <Link href={"/drives"}><p className='cursor-pointer hover:text-gray-600 transition-colors'>Drive</p></Link>
        <Link href={"/networks"}><p className='cursor-pointer hover:text-gray-600 transition-colors'>Network</p></Link>
          ...
          <div className="p-4">
            ...
            <div className="space-y-2">
              <Link href={"/category"} onClick={closeMobileMenu}>
                <div className="py-3 px-4 hover:bg-gray-100 rounded border-b border-gray-200">
                  Promotional Link
                </div>
              </Link>
              ...
              <div>
                <div className='py-3 px-4 hover:bg-gray-100 rounded border-b border-gray-200 flex items-center justify-between'>
                  <Link href={"/laptops"} onClick={closeMobileMenu}>
              ...
              <Link href={"/category"} onClick={closeMobileMenu}>
                <div className="py-3 px-4 hover:bg-gray-100 rounded">
                  Become A Seller
                </div>
              </Link>
            </div>
