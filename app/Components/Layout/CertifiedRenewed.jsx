...
const products = [
  { id: 2, name: 'Laptops', image: '/laptop.png', href:"/laptops" },
  { id: 3, name: 'Desktop PC', image: '/desktop-PC.png', href:"/desktops" },
  { id: 4, name: 'Mouse', image: '/mouse 1.png', href:"/mice" },
  { id: 5, name: 'Keyboard', image: '/keyboard-1.png', href:"/keyboards" },
  { id: 6, name: 'Monitors', image: '/lcds.png', href:"/monitors" },
  { id: 7, name: 'Headphones', image: '/headphones.png', href:"/drives" },
  { id: 8, name: 'Network', image: '/routers.png', href:"/networks" },
  { id: 11, name: 'Chargers', image: '/chargers.png', href:"/networks" },
  { id: 9, name: 'Printer', image: '/printers.png', href:"/printers" },
  { id: 10, name: 'Tablet', image: '/tablet-img.png', href:"/tablets" },
];
